...
print(data.head())
data.columns = ['user_id', 'product_id','ratings','timestamp'] #giving coloum name
df = data[:int(len(data) * .1)]    # taking sample from large dataset 
# preparing dataset for recommendation 
